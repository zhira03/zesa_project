...
class SolarPanelsScreen extends StatelessWidget {
  const SolarPanelsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
          child: SolarPanelInfoCard(
            solarType: 'Monocrystalline',
            panelCount: 12,
            panelSize: 400,
            funFact:
                'Your panels have offset over 3.2 tonnes of CO₂ this year — equal to planting 145 trees!',
          ),
        ),
      ),
    );
...
class SolarPanelInfoCard extends StatelessWidget {
